      ...
      >
        ...
        <div className="p-5 border-b border-slate-800 bg-slate-950 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] text-blue-400 font-mono font-bold uppercase tracking-widest">Admin Control</span>
            </div>
          </div>
          <button 
            onClick={() => setIsSidebarOpen(false)}
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950/80">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center text-slate-200 border border-slate-700 font-bold uppercase text-xs">
              {profile?.full_name?.substring(0, 2) || 'AD'}
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-xs font-semibold text-white truncate">{profile?.full_name || 'System Administrator'}</p>
        ...
        <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 md:px-6 shrink-0 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 font-mono text-xs text-slate-500">
              ...
              <span className="font-bold text-slate-700 bg-blue-50 px-2 py-0.5 rounded uppercase text-[10px]">Registry Auth Session</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              <div className="flex items-center gap-2 justify-end">
                <p className="text-xs font-bold text-slate-800">{profile?.full_name || 'Administrator'}</p>
                <span className="px-2 py-0.5 bg-blue-100 text-blue-800 font-bold uppercase rounded-md text-[9px] border border-blue-200/60 font-mono shadow-2xs">
                  Admin
                </span>
              </div>
